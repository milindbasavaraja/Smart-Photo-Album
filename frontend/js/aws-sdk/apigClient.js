...
apigClientFactory.newClient = function (config) {
    ...
    var invokeUrl = 'https://h9eqw1xe31.execute-api.us-east-1.amazonaws.com/dev';
    ...
    apigClient.uploadAudioBucketFilenamePut = function (params, body, additionalParams) {
        if(additionalParams === undefined) { additionalParams = {}; }
        
        apiGateway.core.utils.assertParametersDefined(params, ['filename', 'bucket', 'Access-Control-Allow-Origin', 'Access-Control-Allow-Headers', 'Access-Control-Allow-Methods'], ['body']);
        
        var uploadAudioBucketFilenamePutRequest = {
            verb: 'put'.toUpperCase(),
            path: pathComponent + uritemplate('/upload-audio/{bucket}/{filename}').expand(apiGateway.core.utils.parseParametersToObject(params, ['filename', 'bucket', ])),
        ...
        return apiGatewayClient.makeRequest(uploadAudioBucketFilenamePutRequest, authType, additionalParams, config.apiKey);
    };
    
    
    apigClient.uploadAudioBucketFilenameOptions = function (params, body, additionalParams) {
        if(additionalParams === undefined) { additionalParams = {}; }
        
        apiGateway.core.utils.assertParametersDefined(params, [], ['body']);
        
        var uploadAudioBucketFilenameOptionsRequest = {
            verb: 'options'.toUpperCase(),
            path: pathComponent + uritemplate('/upload-audio/{bucket}/{filename}').expand(apiGateway.core.utils.parseParametersToObject(params, [])),
            headers: apiGateway.core.utils.parseParametersToObject(params, []),
            queryParams: apiGateway.core.utils.parseParametersToObject(params, []),
            body: body
        };
        ...
        return apiGatewayClient.makeRequest(uploadAudioBucketFilenameOptionsRequest, authType, additionalParams, config.apiKey);
    };
    ...
    apigClient.uploadBucketFilenamePut = function (params, body, additionalParams) {
        ...
        apiGateway.core.utils.assertParametersDefined(params, ['filename', 'bucket', 'Access-Control-Allow-Origin', 'Access-Control-Allow-Headers', 'x-amz-meta-customLabels', 'Access-Control-Allow-Methods'], ['body']);
